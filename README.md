...
[![License](https://img.shields.io/github/license/Shiyue0x0/MicroBusAnnouncer)](https://github.com/Shiyue0x0/MicroBusAnnouncer/blob/main/LICENSE)
...
2. 点击最上方的卡片 `模拟电显` ，然后选择要运行的路线。也可以点击`线路`页中点击路线名称来更换路线。

3. 此时，您选择的路线已经开始运行。当您位于 `主控` 页时，`Announcer`会根据实时定位，自动进站和出站，并且播放报站语音。

4. 此外，您也可以点击界面下方中央类似铃铛的报站按钮，来手动播放报站。

5. 点击电显下方路线运行图任意一个站点，点击弹窗的`当前站点`按钮，就会切换到这一站，再次点击报站按钮播放当前站点的报站。
