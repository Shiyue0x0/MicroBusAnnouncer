...
7. 喜报！你已经完成了所有的初始设置。现在可以试着自行探索一下，或者是转到[开始运行]([https://github.com/Shiyue0x0/MicroBusAnnouncer/releases](https://github.com/Shiyue0x0/MicroBusAnnouncer/tree/master?tab=readme-ov-file#开始运行)了解Announcer的完整功能。
